...
async def setup_page(q: Q):
    ...
    q.page['preview'] = ui.frame_card(box='preview', title='Preview', path='/body')
...
async def show_example(q: Q, example: Example):
    ...
    preview_card.path = f'/body?e={active_example.name}'
    await q.page.save()
...
example_filenames = [line.strip() for line in read_lines(os.path.join(example_dir, 'sources.conf')) if
...
print('')
print(' Go to http://localhost:10101/index')
print('----------------------------------------')
